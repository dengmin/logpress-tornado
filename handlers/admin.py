...
class CategoryHandler(AdminBaseHandler):
    ...
    def get(self):
        self.render('admin/category/index.html',
                    categories=Category.select(), nav='category')
...
class PostHandler(AdminBaseHandler):
    ...
    def get(self):
        self.render('admin/post/add.html',
                    category=Category.select(), nav='post')
    ...
    def post(self):
        ...
        post = Post.create(title=title, category=category,
                           slug=slug, content=content, tags=tag)
